...
namespace app\modules\frontadmin\models\user_fro_account_flow;
...
class User_fro_account_flow extends BaseActiveRecord implements User_account_interface
{
    ...
    public function rechargeOk($id, $adminUser='', $adminNote=''){
        ...
        if($rs){
            ...
            if( $userAccountModel instanceof User_account ) {
                ...
                return $userAccountModel->recharge($this->amount, User_account::C_ACCOUNT_FROZEN, "保证金账户充值");
            }
        }
        return false;
    }
    ...
    public function cash($userId, $amount=0, $payment=null, $userNote=null, $processType=self::PROCESS_TYPE_CASH){
    ...
    public function getCashUser(){
        return $this->hasOne(User_fro_account_flow_cashuser::className(), [
            'flow_id' => 'id'
        ]);
    }
}