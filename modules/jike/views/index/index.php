    ...
    <div class="content-wrapper">
        ...
        <div class="catgory-nav">
            <ul>
                ...
                <li >
                    <span></span><a href="#" class="btn-ajax-link active " data-type-id="0">全部奖品</a>
                </li>
                <?php
                foreach($prizegoodsTypeList as $type){
                    ?>
                    <li>
                        <span></span><a href="#" class="btn-ajax-link" data-type-id="<?=$type->type_id?>"><?=$type->type_name?></a>
                    </li>
                    <?php
                }
                ?>
        ...
        <div class="goods-list text-center" id="goods-list"></div>
