...
class LetvCloudV1 {
	...
	public $user_unique='aprd6nszca';
	public $secret_key='c247f61e7929b8ac1ce120a86e8fbace';
	 ...
	 * @return string
	 */
	public function videoList($index=1,$size=30,$status=ALL){
		$api = 'video.list';
		$params['index'] = $index;
		$params['size'] = $size;
	 ...
	 * @return string
	 */
	public function videoGetPlayinterface($uu,$vu,$type,$pu="",$auto_play=null,$width=400,$height=450){
		$args = array();
		$args['uu'] = $uu;
		$args['vu'] = $vu;
		if(!empty($pu)){
		...
		if($type == "url"){
			...
			$res = '<embed src="http://yuntv.letv.com/bcloud.swf" allowFullScreen="true" quality="high" width="'.$width.'" height="'.$height.'" align="middle" allowScriptAccess="always" flashvars="'.$queryString.'" type="application/x-shockwave-flash"></embed>';
		}
		return $res;
	}
	...
	public function curl($url, $postFields = null) {
		...
		else
		{
			...
			if (200 !== $httpStatusCode)
			{
				...
				print_r($reponse,$httpStatusCode);
			}
		}
		curl_close($ch);
		return $reponse;
